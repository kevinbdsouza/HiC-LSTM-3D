...
class DownstreamTasks:
    def __init__(self, cfg, dir, chr, cell, mode):
        ...
        self.exp = "map"
        self.downstream_helper_ob = DownstreamHelper(cfg, cell, chr, mode)
        self.data_ob = DataPrepHic(cfg, cell, mode='train', chr=str(chr))
    ...
    def run_rna_seq(self, cfg):
        ...
        np.save(self.saved_model_dir + '/map_dict_rnaseq_' + str(self.chr) + '.npy', mean_map_dict)
    ...
    def run_pe(self, cfg):
        ...
        np.save(self.saved_model_dir + '/map_dict_pe_' + str(self.chr) + '.npy', mean_map_dict)
    ...
    def run_fires(self, cfg):
        ...
        np.save(self.saved_model_dir + '/map_dict_fire_' + str(self.chr) + '.npy', mean_map_dict)
    ...
    def run_rep_timings(self, cfg):
        ...
        np.save(self.saved_model_dir + '/map_dict_rep_' + str(self.chr) + '.npy', mean_map_dict)
    ...
    def run_loops(self, cfg):
        ...
        np.save(self.saved_model_dir + '/map_dict_loop_' + str(self.chr) + '.npy', mean_map_dict)
    ...
    def run_domains(self, cfg):
        ...
        np.save(self.saved_model_dir + '/map_dict_domain_' + str(self.chr) + '.npy', mean_map_dict)
    ...
    def run_sub_compartments(self, cfg):
        ...
        np.save(self.saved_model_dir + '/map_dict_sbc_' + str(self.chr) + '.npy', mean_map_dict)
    ...
    def run_p_and_e(self, cfg):
        ...
        for e in element_list:
            ...
            np.save(self.saved_model_dir + '/map_dict_' + str(e) + '_' + str(self.chr) + '.npy', mean_map_dict)
    ...
    def run_tss(self, cfg):
        ...
        np.save(self.saved_model_dir + '/map_dict_tss_' + str(self.chr) + '.npy', mean_map_dict)
...
if __name__ == '__main__':
    ...
    for chr in test_chr:
        ...
        downstream_ob = DownstreamTasks(cfg, model_dir, chr, cell="GM12878", mode='lstm')
        ...
        # mapdict_loops = downstream_ob.run_loops(cfg)

        # mapdict_domains = downstream_ob.run_domains(cfg)

        #mapdict_subcomp = downstream_ob.run_sub_compartments(cfg)

        # mapdict_p_e = downstream_ob.run_p_and_e(cfg)

        mapdict_tss = downstream_ob.run_tss(cfg)
