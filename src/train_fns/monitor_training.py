...
class MonitorTraining:
    ...
    def monitor_loss_iter(self, callback, loss, r2, iter_num):
        self.losses_iter.append(loss)
        loss_dict_iter = {'loss_iter': loss, 'r2_iter': r2}
        self.add_tf_summary(callback, loss_dict_iter, iter_num)

    def monitor_loss_epoch(self, callback, epoch_num):
        ...
        if epoch_loss < self.best_loss:
            print('Total loss decreased from {} to {}, saving weights'.format(self.best_loss, epoch_loss))
