...
class PlotMap:
    def __init__(self, cfg):
        self.cfg = cfg
        self.path = "/home/kevindsouza/Documents/projects/hic_lstm/src/saved_model/model_lstm/log_run/"
    ...
    def plot_hidden(self, hidden_list):
        ...
        ax1.plot(hidden_list, map_hidden, marker='', markersize=14, color="C0", linewidth=2,
                 label='Hi-C-LSTM')
        ax1.plot(hidden_list, map_2_layer, marker='', markersize=14, color="C1", linewidth=2, linestyle='dashed',
                 label='Hi-C-LSTM, No.Layers: 2')
        ax1.plot(hidden_list, map_no_ln, marker='^', markersize=14, color="C2", linewidth=2,
                 label='Hi-C-LSTM, w/o Layer Norm')
        ax1.plot(hidden_list, map_dropout, marker='+', markersize=14, color="C4", linewidth=2,
                 label='Hi-C-LSTM, w Dropout')
        ax1.plot(hidden_list, map_bidir, marker='v', markersize=14, color="C5", linewidth=2, label='Hi-C-LSTM, '
                                                                                                   'Bidirectional Lstm')

        ax2.plot(hidden_list, r2_hidden, marker='', markersize=14, color="C0", linewidth=2,
                 label='Hi-C-LSTM')
        ax2.plot(hidden_list, r2_2_layer, marker='', markersize=14, color="C1", linewidth=2, linestyle='dashed',
                 label='Hi-C-LSTM, No.Layers: 2')
        ax2.plot(hidden_list, r2_no_ln, marker='^', markersize=14, color="C2", linewidth=2,
                 label='Hi-C-LSTM, w/o Layer Norm')
        ax2.plot(hidden_list, r2_dropout, marker='+', markersize=14, color="C4", linewidth=2,
                 label='Hi-C-LSTM, w Dropout')
        ax2.plot(hidden_list, r2_bidir, marker='v', markersize=14, color="C5", linewidth=2, label='Hi-C-LSTM, '
                                                                                                  'Bidirectional Lstm')

        ax1.tick_params(axis="x", labelrotation=90, labelsize=20)
        ax2.tick_params(axis="x", labelrotation=90, labelsize=20)
        ax1.tick_params(axis="y", labelsize=20)
        ax1.set_xticks(hidden_list)
        ax1.set_xticklabels(hidden_list)
        ax2.set_xticks(hidden_list)
        ax2.set_xticklabels(hidden_list)
        ax1.set_xlabel('Embedding Size', fontsize=20)
        ax2.set_xlabel('Embedding Size', fontsize=20)
        ax1.set_ylabel('Avg mAP Across Tasks', fontsize=20)
        ax2.set_ylabel('Avg Hi-C R-squared', fontsize=20)

        handles, labels = ax2.get_legend_handles_labels()
        fig.legend(handles, labels, loc='center right', fontsize=18)
    ...
    def plot_gbr(self):
        ig_log_df = pd.DataFrame(np.load("/home/kevindsouza/Documents/projects/hic_lstm/data/ig_log_df_comb.npy"))
    ...
    def plot_r2(self):
        ...
        ax1.plot(pos, r1_hiclstm_full, marker='', markersize=14, color='C0', label='Hi-C-LSTM')
        ax1.plot(pos, r1_hiclstm_lstm, marker='o', markersize=14, color='C0', label='Hi-C-LSTM-LSTM')
        ax1.plot(pos, r1_hiclstm_cnn, marker='^', markersize=14, color='C0', label='Hi-C-LSTM-CNN')
        ax1.plot(pos, r1_hiclstm_fc, marker='v', markersize=14, color='C0', label='Hi-C-LSTM-FC')
        ax1.plot(pos, r1_sci_lstm, marker='o', markersize=14, color='C1', label='SCI-LSTM')
        ax1.plot(pos, r1_sci_cnn, marker='^', markersize=14, color='C1', label='SCI-CNN')
        ax1.plot(pos, r1_sci_fc, marker='v', markersize=14, color='C1', label='SCI-FC')
        ax1.plot(pos, r1_sniper_lstm, marker='o', markersize=14, color='C2', label='SNIPER-LSTM')
        ax1.plot(pos, r1_sniper_cnn, marker='^', markersize=14, color='C2', label='SNIPER-CNN')
        ax1.plot(pos, r1_sniper_fc, marker='v', markersize=14, color='C2', label='SNIPER-FC')

        # ax2.plot(pos, r2_hiclstm_full, marker='', markersize=14, color='C0', label='Hi-C-LSTM')
        ax2.plot(pos, r2_hiclstm_lstm, marker='o', markersize=14, color='C0', label='Hi-C-LSTM-LSTM')
        ax2.plot(pos, r2_hiclstm_cnn, marker='^', markersize=14, color='C0', label='Hi-C-LSTM-CNN')
        ax2.plot(pos, r2_hiclstm_fc, marker='v', markersize=14, color='C0', label='Hi-C-LSTM-FC')
        ax2.plot(pos, r2_sci_lstm, marker='o', markersize=14, color='C1', label='SCI-LSTM')
        ax2.plot(pos, r2_sci_cnn, marker='^', markersize=14, color='C1', label='SCI-CNN')
        ax2.plot(pos, r2_sci_fc, marker='v', markersize=14, color='C1', label='SCI-FC')
        ax2.plot(pos, r2_sniper_lstm, marker='o', markersize=14, color='C2', label='SNIPER-LSTM')
        ax2.plot(pos, r2_sniper_cnn, marker='^', markersize=14, color='C2', label='SNIPER-CNN')
        ax2.plot(pos, r2_sniper_fc, marker='v', markersize=14, color='C2', label='SNIPER-FC')
    ...
    def plot_knockout_results(self):
        ...
        df_main = pd.DataFrame(columns=["pos", "No KO", "CTCF KO", "RAD21 KO", "SMC3 KO", "Inverted CTCF"])
        df_main["pos"] = pos
        df_main["No KO"] = predicted_probs
        df_main["Convergent CTCF"] = convctcf_probs
        df_main["CTCF KO"] = ctcfko_probs
        df_main["Divergent CTCF"] = divctcf_probs
        df_main["RAD21 KO"] = radko_probs
        df_main["SMC3 KO"] = smcko_probs

        palette = {"No KO": "C3", "Convergent CTCF": "C5", "CTCF KO": "C0", "Divergent CTCF": "C1", "RAD21 KO": "C2",
                   "SMC3 KO": "C4"}
        plt.figure(figsize=(10, 8))
        plt.xticks(rotation=90, fontsize=20)
        plt.yticks(fontsize=20)
        plt.xlabel("Distance between positions in Mbp", fontsize=20)
        plt.ylabel("Average Contact Strength ", fontsize=20)
        plt.plot('pos', 'No KO', data=df_main, marker='o', markersize=14, color="C3", linewidth=2,
                 label="No KO")
        plt.plot('pos', 'Convergent CTCF', data=df_main, marker='v', markersize=14, color="C5", linewidth=2,
                 label="Convergent CTCF")
        plt.plot('pos', 'CTCF KO', data=df_main, marker='3', markersize=14, color="C0", linewidth=2, label="CTCF KO")
        plt.plot('pos', 'Divergent CTCF', data=df_main, marker='*', markersize=14, color="C1", linewidth=2,
                 linestyle='dashed',
                 label="Divergent CTCF")
        plt.plot('pos', 'RAD21 KO', data=df_main, marker='^', markersize=14, color="C2", linewidth=2, label="RAD21 KO")
        plt.plot('pos', 'SMC3 KO', data=df_main, marker='4', markersize=14, color="C4", linewidth=2, label="SMC3 KO")
        plt.legend(fontsize=18)
        plt.show()
    ...
    def plot_symmetry(self):
        ...
        plt.xlabel("Error in symmetric predictions", fontsize=16)
        plt.show()
